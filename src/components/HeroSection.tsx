...
const HeroSection = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-hero flex items-center justify-center relative overflow-hidden pt-16">
          ...
          <div className="space-y-6 lg:space-y-8 text-center lg:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 sm:gap-6 lg:gap-8 pt-6 lg:pt-8 border-t border-border">
              <div className="text-center">
                ...
                <div className="text-xs sm:text-sm text-muted-foreground">{t('hero.years')}</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-primary">5000+</div>
                <div className="text-xs sm:text-sm text-muted-foreground">{t('hero.patients')}</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-primary">24/7</div>
                <div className="text-xs sm:text-sm text-muted-foreground">{t('hero.emergency')}</div>
              </div>
            </div>
          </div>
